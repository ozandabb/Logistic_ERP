...
import PurchaseOrder from '../../../../Controllers/PurchaseOrder.controller'
import { FormSelect } from '../../../../Components/Form';
import { Spinner } from '../../../../Components/smallspinner';
import '../../../../assersts/sharedcss/spinner.css';
import { ItemCard } from './itemCard';
import { AddOrderPopUp } from './PopUp';
            ...
            if(!error){
                ...
                this.setState(pre=>{
                    return {
                        ...
                        suppliers:[{ label : 'Select the Supplier' ,value : 'NONE' } , 
                ...
                <div className="wrapper-wx" style={{height:"100hv"}}>
                    <div className="container-fluid" style={{paddingLeft:30}}>
                        ...
                        <div className="col-sm-9">
                            <h6 style={{paddingTop:"10px", paddingLeft:"5px"}}>Add Order<br></br>
                            <span className="text-muted small">Dashboard / Add Order</span></h6>
                        </div>
