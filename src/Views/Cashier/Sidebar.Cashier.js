...
class Cashier_sidebar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    return (
        <div>
            ...
            <SidebarContent>
                ...
                <MenuItem active={activemenu === 'DASHBOARD'} icon={<FontAwesomeIcon icon={faHome} />}>Dashboard<Link to="/Cashier/dashboard"/></MenuItem>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(Cashier_sidebar));
