...
class DetailsEachPaymentCom extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async componentDidMount() {
        const res = await Payment_CONTROLLER.getSupplierByID(this.props.SUP_ID, this.props.auth.token);
        // this.setState({
...
export default connect(mapStateToProps, null)(withRouter(DetailsEachPaymentCom));