...
class Warehouse_Sidebar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    return (
        <div>
            ...
            <SidebarContent>
                ...
                <MenuItem active={activemenu === 'DASHBOARD'} icon={<FontAwesomeIcon icon={faHome} />}>Dashboard<Link to="/Warehouse/dashboard"/></MenuItem>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(Warehouse_Sidebar));
