                                ...
                                <div className="col-sm-9">
                                    <div className="row">
                                        <div className="col-sm">
                                            <h6 style={{paddingTop:"10px", paddingLeft:"5px"}}>Performance Evaluation<br></br>
                                            <span className="text-muted small">Dashboard / Goals</span></h6>
                                        </div>
                                    
                                    </div>
                                </div>
                                <div className="col-sm-3">
                                    <Button variant="" style={{backgroundColor:"#475466" , color:"#FFFFFF", width:"100%",  cursor: 'pointer'}} >Create Employee Goal</Button>
                                </div>
                        </div>
                                    ...
                                    <Card.Body>
                                            ...
                                            <div className="col-12 bg-white mt-1 pb-1" >
                                                <form onSubmit={(e) => this.onFormSubmit(e)}>
                                                        <h6 className="text-header py-3 mb-0 font-weight-bold line-hight-1">Enter Goal Details<br></br>
...
export default connect(mapStateToProps, null)(withRouter(Goals));