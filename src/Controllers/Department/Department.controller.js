...
class Departmentcontroller{
    constructor(){
        this.api = {
            getOneDeptByID: "/api/departments/getone",
    ...
    // get one dept by id
    getOneDeptByID = async (id, token) => {
        var resp = 600;
        var userData = {}
        const data = await Axios.get(
            `${Config.host}${Config.port}${this.api.getOneDeptByID}/${id}`,
...
var UserObject = new Departmentcontroller();
